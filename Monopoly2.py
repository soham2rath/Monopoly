...
bank = {"bal": 1000000}
players = {1: {"name": "Soham R.", "bal": INITIAL_BALANCE, "pos": START_POSITION, "property": []},
...
#board dictionary
board = {1:  ["Shrine of Ressurection(GO)", "0", False],
